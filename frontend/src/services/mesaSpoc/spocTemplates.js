export function gerarScriptsSpoc({ nome, telefone, tentativa, chamadoSecundario, notaResolucao, chamadoPrimario }) {
    ...
    const primeiroNome = nome ? nome.split(' ')[0] : '[NOME DO COLABORADOR]';
